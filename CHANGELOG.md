...
- Search results can now be opened in a new tab with a middle-click,
  Command-click on macOS, or Control-click on Windows and Linux.
- Normal clicks continue to open results in the current tab.
